...
public class Node {
  ...
  public static void main(String[] args) {
     Node a = new Node(1, new Node(2, null, new Node(3)), new Node(4, new Node(5), null));
     a.left.left = new Node(6, null, null); 
     ...
     /****
     Node b = new Node(1, null, new Node(2, null, new Node(3, null, new Node(4, null, new Node(5, null, null))))); 
     System.out.println( b ); 
     b.display();
     Node c = new Node(1, new Node(2, new Node(3, new Node(4, new Node(5, null, null), null), null), null), null); 
     System.out.println(c); 
     c.display(); 
     Node d = new Node(1, new Node(2, new Node(4, null, null), new Node(5, null, null)), new Node(3, null, null)); 
     d.display();
     *****/
  }
}
